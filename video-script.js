...
let getAffirmation = () => {
    ...
    affirmationContainer.innerHTML = "<video width='240' height='320' autoplay controls src=" + newVideo + " class='affirmation' >Your browser does not support this video</video>";
